package com.alpen.finalwork.Graphviz;
...
public class GraphViz {
	 ...
	 */
	private static String TEMP_DIR = "C:\\Users\\cde\\Desktop";

	/**
	 * Where is your dot program located? It will be called externally.
	 */
	public static String DOT = "D:\\Program Files (x86)\\Graphviz\\release\\bin\\dot.exe";
	public static String FDP = "D:\\Program Files (x86)\\Graphviz\\release\\bin\\fdp.exe";
	public static String NEATO = "D:\\Program Files (x86)\\Graphviz\\release\\bin\\neato.exe";
	 ...
	 */
	public byte[] getGraph(String dot_source, String type,String layout) {
		File dot;
		...
		try {
			...
			if (dot != null) {
				img_stream = get_img_stream(dot, type, layout);
	 ...
	 */
	private byte[] get_img_stream(File dot, String type, String layout) {
		File img;
		byte[] img_stream = null;
		...
		try {
			...
			//DOT can be replaced by NEATO
//			String[] args = { layout, "-T" + type, "-Gdpi=" + dpiSizes[this.currentDpiPos], dot.getAbsolutePath(), "-o",
//					img.getAbsolutePath() };
			String[] args = { layout, "-T" + type, dot.getAbsolutePath(), "-o",
					img.getAbsolutePath() };
	...
	private File writeDotSourceToFile(String str) throws java.io.IOException {
		...
		try {
			...
			fout.write(str);
			BufferedWriter br = new BufferedWriter(new FileWriter("C:\\Users\\cde\\Desktop\\dotsource.dot"));
			br.write(str);
			br.flush();
			br.close();
			fout.close();
